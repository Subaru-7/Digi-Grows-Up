...
function WaveGrid({ pointsOpacity }: { pointsOpacity: number }) {
  ...
  return (
    <group>
      ...
      <points ref={meshRef}>
        ...
        <pointsMaterial size={0.06} vertexColors transparent opacity={0.35} sizeAttenuation={true} />
      </points>
    </group>
  )
}
    ...
    <div className="w-full h-screen bg-black relative overflow-hidden">
      <Canvas
        ...
        style={{
          ...
          filter: canvasBlur ? `blur(${canvasBlur}px)` : undefined,
        }}
      >
        ...
        <group rotation={[-Math.PI / 2 + 0.05, 0, 0]}>
          <WaveGrid pointsOpacity={pointsOpacity} />
        </group>
      </Canvas>
