                ...
                activeTab === key && (
                  ...
                  >
                    ...
                    <div className="text-center mb-16 px-4 sm:px-0">
                      ...
                      <p className="text-lg sm:text-xl text-black max-w-3xl mx-auto">{service.intro}</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
                      ...
                      <Card className="shadow-lg rounded-xl border border-gray-300 bg-white">
                        <CardHeader>
                          <CardTitle className="text-xl font-semibold text-black">What You Get</CardTitle>
                        </CardHeader>
                        <CardContent>
                      ...
                      <Card className="shadow-lg rounded-xl border border-gray-300 bg-white">
                        <CardHeader>
                          <CardTitle className="text-xl font-semibold text-black">Expected Outcomes</CardTitle>
                        </CardHeader>
                        <CardContent>
                          <ul className="space-y-4">
                            {service.outcomes.map((outcome, index) => (
                              ...
                              >
                                ...
                                <span className="text-black leading-relaxed">{outcome}</span>
                              </motion.li>
                            ))}
                          </ul>
                        </CardContent>
                    ...
                    {/* FAQ */}
                    <Card className="mb-20 shadow-lg rounded-xl border border-gray-300 bg-white">
                      <CardHeader>
                        <CardTitle className="text-xl font-semibold text-black">Frequently Asked Questions</CardTitle>
                      </CardHeader>
                      <CardContent>
                        <Accordion type="single" collapsible>
                          {service.faqs.map((faq, index) => (
                            <AccordionItem key={index} value={`item-${index}`}>
                              <AccordionTrigger className="text-black font-medium text-lg hover:text-indigo-600 transition-colors">
                                {faq.question}
                              </AccordionTrigger>
                    ...
                    <div className="text-center">
                      <Card className="bg-black shadow-lg rounded-xl border-0">
                        <CardContent className="pt-8 pb-10 px-8">
                          <h3 className="text-2xl sm:text-3xl font-extrabold mb-4 text-white drop-shadow-md">
                            Ready to Get Started?
                          </h3>
                          <p className="text-white mb-8 max-w-2xl mx-auto text-lg leading-relaxed drop-shadow-sm">
                          ...
                          <ProposalButton
                            ...
                            className="relative inline-block px-8 py-3 font-semibold text-white rounded-lg overflow-hidden
                              before:absolute before:inset-0 before:bg-black before:opacity-0 before:transition-opacity before:duration-300 hover:before:opacity-10
                              after:absolute after:inset-0 after:bg-black after:opacity-0 after:rounded-lg after:-z-10"
                          >
                            Request Proposal
                          </ProposalButton>
                        </CardContent>
