                ...
                activeTab === key && (
                  ...
                  >
                    ...
                    <div className="text-center mb-16 px-4 sm:px-0">
                      <h2 className="text-3xl sm:text-4xl font-extrabold text-black mb-4">{service.title}</h2>
                      <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">{service.intro}</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
                      ...
                      <Card className="shadow-lg rounded-xl border border-gray-100">
                        <CardHeader>
                          <CardTitle className="text-xl font-semibold text-gray-900">What You Get</CardTitle>
                        </CardHeader>
                        <CardContent>
                      ...
                      <Card className="shadow-lg rounded-xl border border-gray-100">
                        <CardHeader>
                          <CardTitle className="text-xl font-semibold text-gray-900">Expected Outcomes</CardTitle>
                        </CardHeader>
                        <CardContent>
                          <ul className="space-y-4">
                        ...
                        <Accordion type="single" collapsible>
                          {service.faqs.map((faq, index) => (
                            <AccordionItem key={index} value={`item-${index}`}>
                              <AccordionTrigger className="text-gray-800 font-medium text-lg hover:text-indigo-600 transition-colors">
                                {faq.question}
                              </AccordionTrigger>
                    ...
                    <div className="text-center">
                      <Card className="bg-gradient-to-r from-indigo-500 via-purple-600 to-pink-500 shadow-lg rounded-xl border-0">
                        <CardContent className="pt-8 pb-10 px-8">
                          <h3 className="text-2xl sm:text-3xl font-extrabold mb-4 text-white drop-shadow-md">
                            Ready to Get Started?
                          </h3>
                          <p className="text-indigo-100 mb-8 max-w-2xl mx-auto text-lg leading-relaxed drop-shadow-sm">
                            Let's discuss how {service.title.toLowerCase()} can drive growth for your business.
                          </p>
                          <ProposalButton
                            variant="ghost"
                            size="lg"
                            className="relative inline-block px-8 py-3 font-semibold text-white rounded-lg overflow-hidden
                              before:absolute before:inset-0 before:bg-gradient-to-r before:from-white before:via-white before:to-white
                              before:opacity-10 before:blur-md before:transition-transform before:duration-500 hover:before:translate-x-full
                              after:absolute after:inset-0 after:bg-gradient-to-r after:from-indigo-400 after:via-purple-500 after:to-pink-600
                              after:opacity-90 after:rounded-lg after:-z-10"
                          >
                            Request Proposal
                          </ProposalButton>
                        </CardContent>
