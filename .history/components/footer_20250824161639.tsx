    ...
    <footer className="border-t border-border bg-gradient-to-br from-background to-muted/30">
      <div className="container py-16">
          ...
          <div className="space-y-4">
            ...
            <div className="pt-4">
              <Button
                variant="outline"
                size="sm"
                className="w-full group bg-transparent hover:bg-primary hover:text-background"
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <p className="text-xs text-muted-foreground">Made with ❤️ for ambitious brands</p>
        </div>
      </div>
